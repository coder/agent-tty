...
## Current shipped state (2026-03-23)
...
- and static bundle review pages generated by `npm run review-bundle -- <bundle-dir>`.

The remaining gaps are no longer about missing artifact classes or a missing local review page. The dedicated `unicode-grid` and `scrollback-demo` fixtures, their matching E2E coverage, the Week 4 proof bundles, the Week 5 review helper, and the Week 5 recovery proofs are now part of the shipped validation story.
