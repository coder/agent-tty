// =============================================================================
// VENDORED FROM mattpocock/sandcastle PR #495.
//
// Source: src/sandboxes/coder.ts at commit
//   4c5ddb8821d7ba8287a08c4950dc8e886a0e3e3a
// (https://github.com/mattpocock/sandcastle/pull/495).
//
// We vendor the file because the @ai-hero/sandcastle/sandboxes/coder export is
// not yet shipped in any released version. The file imports nothing from
// sandcastle's internal source tree other than ../SandboxProvider.js, whose
// full surface is already re-exported from the published @ai-hero/sandcastle
// main entry. The edits below use the published package types and mirror the
// tiny published createIsolatedSandboxProvider runtime helper locally so merely
