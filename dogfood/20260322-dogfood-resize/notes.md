...
- `06-screenshot-after-resize-large.json` *(error JSON only; no PNG produced)*
- `07-resize-small.json`
- `08-wait-stable-small.json`
- `09-screenshot-after-resize-small.json` *(error JSON only; no PNG produced)*
- `10-snapshot-final.json` *(error JSON only)*
