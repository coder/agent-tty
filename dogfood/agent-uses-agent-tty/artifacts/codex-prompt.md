...
```bash
bash "/var/folders/pq/ft6166r921ddfcph0dyg4skc0000gn/T/agent-uses-agent-tty.XXXXXX.Swdm3KlnG7/workspaces/codex/run-inner-nvim-proof.sh"
```
...
After the helper exits, report only whether it passed and list the three generated files: `/var/folders/pq/ft6166r921ddfcph0dyg4skc0000gn/T/agent-uses-agent-tty.XXXXXX.Swdm3KlnG7/workspaces/codex/demo-note.txt`, `/var/folders/pq/ft6166r921ddfcph0dyg4skc0000gn/T/agent-uses-agent-tty.XXXXXX.Swdm3KlnG7/workspaces/codex/artifacts/inner-nvim.cast`, and `/var/folders/pq/ft6166r921ddfcph0dyg4skc0000gn/T/agent-uses-agent-tty.XXXXXX.Swdm3KlnG7/workspaces/codex/artifacts/inner-nvim.webm`.
